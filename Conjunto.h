...
class Conjunto
{
    ...
    private:
        ...
        struct Nodo
        {
            ...
            Nodo(const T& v, Nodo* izquierdo, Nodo* derecho, Nodo* pad)
            : valor(v), izq(izquierdo), der(derecho), _padre(pad) {}
        ...
        unsigned int cardinalRecursivo(Nodo* n) const;
        Nodo* obtenerMinimoSubDerecho(Nodo* der);
